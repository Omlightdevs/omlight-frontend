...
class CategoryServices {
  ...
  public async CreateNewCategory(data: INewCategoryProps) {
    try {
      const NewLight = await axios.post<IResponseProps>(
  ...
  public async updatingCategoryById(id: string, data: ICategoryProps) {
    try {
      const UpdateCategory = await axios.put<IResponseProps>(
  ...
  public async deleteCategoryById(id: string) {
    try {
      const deletedCategory = await axios.delete<IResponseProps>(
